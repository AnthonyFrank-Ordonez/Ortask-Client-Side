...
const PendingTasks = ({ setPendingOpen, isPendingOpen }: PendingTasksProps) => {
	return (
		<div className='bg-tertiary/20 rounded-lg shadow border-2 border-gray-400/10 h-auto lg:h-auto relative ml-3'>
			<div className='accordion'>
				...
				>
					<h2 className='text-xl font-bold text-tertiary'>Pending</h2>
					<svg
						className={`w-6 h-6 text-tertiary transition-transform duration-200 ${isPendingOpen ? 'transform rotate-180' : ''}`}
						fill='none'
						stroke='currentColor'
						viewBox='0 0 24 24'
					>
					...
					<table className='min-w-full divide-y divide-gray-200'>
						...
						<tbody className='bg-white divide-y divide-gray-200'>
							<tr>
								...
								<td className='px-4 py-4 whitespace-nowrap text-sm uppercase font-medium text-black'>
									Not Started
								</td>
							</tr>
